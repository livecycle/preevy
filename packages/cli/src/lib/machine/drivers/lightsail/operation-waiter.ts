...
export function waitUntilAllOperationsSucceed(config: WaiterConfiguration<LightsailClient>, command: Promise<{ operation?: Operation }>): Promise<void>
export async function waitUntilAllOperationsSucceed(config: WaiterConfiguration<LightsailClient>, operationsOrcommand: Operation[] | Promise<{ operations?: Operation[] } | { operation?: Operation }>): Promise<void> {
  let operations: Operation[] = await (async () => {
