...
export type BaseEmitter = Pick<EventEmitter, 'on' | 'once' | 'removeListener' | 'emit'>

export const simpleEmitter = <T extends Record<string, unknown>>(e: BaseEmitter = new EventEmitter()) => ({
