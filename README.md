...
3. Use the `up` command to provision a new VM with your application: `preevy up`
4. Access and share your new preview environment by using the `*.livecycle.run` link provided in the command output.
